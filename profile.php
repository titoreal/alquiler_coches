...
<title>Portal de Renta de Autos | Mi Perfil</title>
<!--Bootstrap -->
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" value="<?php echo htmlentities($result->dob);?>" name="dob" placeholder="dd/mm/aaaa" id="birth-date" type="text" >
            </div>
            <div class="form-group">
