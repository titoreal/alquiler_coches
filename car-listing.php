    ...
    <div class="container">
      <div class="row">
            ...
            foreach ($results as $result) {  ?>
              <div class="product-listing-m gray-bg">
                ...
                <div class="product-listing-content">
                  ...
                  <p class="list-price">$<?php echo htmlentities($result->PricePerDay); ?> Tarifa Diaria</p>
                  <ul>
                    <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity); ?>
                      asientos</li>
                    <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear); ?> modelo
                    </li>
                    <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->FuelType); ?></li>
                  </ul>
                  <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>" class="btn">Ver
                    Detalles <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                </div>
              </div>
          <?php }
          } ?>
        ...
        <aside class="col-md-3 col-md-pull-9">
            ...
            <div class="sidebar_filter">
              <form action="search-carresult.php" method="post">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Buscar Vehículo</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-car" aria-hidden="true"></i> Vehículos recientemente listados</h5>
            </div>
                  ...
                  foreach ($results as $result) {  ?>
                    ...
                    <li class="gray-bg">
                      ...
                      <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->BrandName); ?>
                        ...
                        <p class="widget_price">$<?php echo htmlentities($result->PricePerDay); ?> Tarifa
                          Diaria</p>
                      </div>
                    </li>
                <?php }
