...
<title>Portal de Renta de Autos</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Encuentra el vehículo perfecto para tí.</h1>
            <p>Tenemos más de mil vehículos para tu elección. </p>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Vehículos Nuevos</a></li>
        </ul>
      </div>
...
<span class="price">$<?php echo htmlentities($result->PricePerDay);?> /Diario</span> 
</div>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            ...
            <p>Vehículos usados para la venta</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Nuestra Satisfacción: <span>Clientes</span></h2>
    </div>
    <div class="row">
