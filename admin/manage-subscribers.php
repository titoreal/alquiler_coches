...
<head>
	...
	<title>Portal de Renta de Autos | Administrar: Suscripciones   </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Detalles del Suscriptor</div>
...
<a href="manage-subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('¿Lo quiere borrar?');"><i class="fa fa-close"></i></a>
</td>
