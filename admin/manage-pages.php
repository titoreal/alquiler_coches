...
$query -> execute();
$msg="Página actualizada exitósamente";
...
<head>
	...
	<title>Portal de Renta de Vehículos | Administrador Crear Marcas</title>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="" selected="selected" class="form-control">***Seleccione alguno***</option>
                  <option value="manage-pages.php?type=terms">Terminos y condiciones</option>
                  <option value="manage-pages.php?type=privacy">Privacidad y políticas</option>
			...
			switch($_GET['type'])
			{
				...
				case "privacy" :
									echo "Privacidad y Políticas";
									break;
				
				case "aboutus" :
									echo "Acerca dse nosotros";
									break;
