...
$msg="Reseña inactivada satisfactoriamente";
}
...
$msg="Reseña Publicada Exitósamente";
}
...
<head>
	...
	<title>Portal de Renta de Autos |Administrador: Administración de Reseñas   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Administrar Reseñas</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Reseña del usuario</div>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Desea activar la reseña?')"> Inactiva</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Quiere desactivar la reseña?')"> Activa</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
