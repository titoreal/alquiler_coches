...
<head>
	...
	<title>Portal de Renta de Autos | Administrador: Actualización de imagen 5</title>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Detalles de la Imagen 5 del Vehículo</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imagen 5 vigente</label>
<?php 
$id=intval($_GET['imgid']);
