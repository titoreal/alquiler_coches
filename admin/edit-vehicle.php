...
$msg="Cambios actualizados exitósamente";
...
<head>
	...
	<title>Portal de Renta de Autos | Administrador: Editar Información del vehículo</title>
...
<div class="form-group">
<div class="col-sm-12">
<h4><b>Imágenes del vehículo</b></h4>
</div>
</div>
...
<label for="inlineCheckbox1"> Aire Condicionado </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2"> Seguro de puertas automático </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Frenos ABS </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Airbag  Copiloto </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="passengerairbag" value="1">
<label for="inlineCheckbox3"> Airbag  Copilot </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox3"> Ventanas Automáticas </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Bloqueo Central</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="inlineCheckbox3"> Sensor antigolpes </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Remitir</button>
												</div>
											</div>
