...
$chngpwd1->execute();
$msg="Su contraseña ha sido actualizada exitosamente";
}
else {
$error="La contraseña especificada no es válida.";	
}
}
?>
...
<head>
	...
	<title>Portal de Renta de Autos | Administrador: Cambio de contraseña</title>
