...
<head>
	...
	<title>Portal de Renta de Autos | Administrador: Actualización de imagen 1</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imagen 1 del Vehículo </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Detalles de la Imagen 1 del Vehículo</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imagen 1 vigente</label>
<?php 
$id=intval($_GET['imgid']);
