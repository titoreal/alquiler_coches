...
header('location:index.php');
	...
	if(isset($_REQUEST['del'])) {
		...
		$query->execute();
		$msg = "Registro del vehículo eliminado exitosamente";
	}
...
<head>
	...
	<title>Portal de Renta de vehículos |Administrar: Vehículos   </title>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Desea eliminar?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
