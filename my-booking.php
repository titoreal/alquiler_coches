...
<head>
    ...
    <title>CarroParaTí - Responsive Car Dealer HTML5 Template</title>
    <!--Bootstrap -->
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="col-md-6 col-sm-8">
                        <div class="profile_wrap">
                            <h5 class="uppercase underline">Mi reserva </h5>
...
{  ?>
                                    ...
                                    <li>
                                        ...
                                        <div class="vehicle_title">
                                            ...
                                            <p><b>Desde:</b> <?php echo htmlentities($result->FromDate);?><br />
                                                <b>Hasta:</b> <?php echo htmlentities($result->ToDate);?>
                                            </p>
                                        </div>
                        ...
                        switch ($result->Status) {
                            case 1:
                                echo '<a class="btn outline btn-xs active-btn">Confirmado</a>';
                                break;
                            case 2:
                                echo '<a class="btn outline btn-xs">Cancelado</a>';
                                break;
                            case 3:
                                echo '<a class="btn outline btn-xs">Entregado</a>';
                                break;
                            case 4:
                                echo '<a class="btn outline btn-xs">Recibido</a>';
                                break;
                            default:
                                echo '<a class="btn outline btn-xs">Por confirmar</a>';
                        }
                        ?>
