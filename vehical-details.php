...
if (isset($_POST['submit'])) {
    ...
    if ($lastInsertId) {
        ...
        // Utiliza JavaScript para abrir el PDF en una nueva pestaña
        echo "<script>window.open('gen_rep_reserv.php?useremail=" . urlencode($useremail) . "&vhid=" . urlencode($vhid) . "&fromdate=" . urlencode($fromdate) . "&todate=" . urlencode($todate) . "&message=" . urlencode($message) . "', '_blank');</script>";
    } else {
        echo "<script>alert('Algo salió mal. Por favor inténtelo nuevamente');</script>";
    }
}
...
<head>
    ...
    <title>Portal de Renta de Autos | Detalles del Vehículo</title>
    <!--Bootstrap -->
                            ...
                            <div class="listing_more_info">
                                <div class="listing_detail_wrap">
                                    ...
                                    <ul class="nav nav-tabs gray-bg" role="tablist">
                                        <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Vistazo al
                                                vehículo </a></li>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="accessories">
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Seguro automático de puertas</td>
                        ...
                        <aside class="col-md-3">
                            ...
                            <div class="sidebar_widget">
                                <div class="widget_heading">
                                    <h5><i class="fa fa-envelope" aria-hidden="true"></i>Reserva Ahora</h5>
                                </div>
                                <form method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="fromdate" placeholder="Desde Fecha(dd/mm/aaaa)" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="todate" placeholder="Hasta Fecha(dd/mm/aaaa)" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <?php if ($_SESSION['login']) { ?>
                                        <div class="form-group">
                                            <input type="submit" class="btn" name="submit" value="Reserva Ahora">
                                        </div>
                                    <?php } else { ?>
                                        <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Acceder para Reservar</a>
